(function(){
    /**
     * Initializes the Workflowy Table View by scanning bullets and creating an interactive table.
     */
    function initWorkflowyTableView(){
        /**
        ...
        // Start by auto-scrolling to load all bullets and then build the table
        autoScroll(buildTable);
    }
    ...
    function injectTableButton(){
        ...
        tableBtn.onclick = function(){
            ...
            if(tables.length > 0){
                ...
                autoScroll(initWorkflowyTableView);
            }
        };
    ...
    /**
     * Displays messages using Workflowy's messaging system or falls back to alert.
     * @param {string} msg - The message to display.
     */
    function showMessage(msg){
        if(typeof WF !== "undefined" && WF.showMessage){
    ...
    /**
     * Automatically scrolls to load all bullets and initializes the table button.
     */
    function initializeBookmarklet(){
        // Start auto-scrolling to load all bullets, then inject the table button
        autoScroll(injectTableButton);
    }
